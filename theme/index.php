...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
		...
		<div class="form-group">
        <input type="text" class="form-control" placeholder="Registration Number" name="reg_number" id="reg_number" />
        </div>
		...
		<div class="form-group">
        <input type="text" class="form-control" placeholder="Phone Number" name="phone_number" id="number" />
        <span id="check-e"></span>
        </div>
